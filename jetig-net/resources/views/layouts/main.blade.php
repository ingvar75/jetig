...
<head><!-- Created by IG-->
    ...
    <style>.jet-content .jet-postcontent-0 .layout-item-0 { border-top-width:1px;border-top-style:solid;border-top-color:#776D50;margin-top: 5px;margin-bottom: 5px;  }
        .jet-content .jet-postcontent-0 .layout-item-1 { padding-right: 10px;padding-left: 10px;  }
...
<div id="jet-main">
    ...
    <div class="jet-sheet clearfix">
        <div class="jet-layout-wrapper">
                ...
                <div class="jet-content-layout-row">
                    ...
                    @yield('content')
                        ...
                        <div class="jet-block clearfix">
                            ...
                            <div class="jet-blockcontent"><div>
                        ...
                        <div class="jet-block clearfix">
                            ...
                            <div class="jet-blockcontent"><p><img width="184" height="210" alt="" src="images/blockimage4.jpg" class=""></p><p style="text-align: center;"><a href="#">Read more »</a></p></div>
            ...
            <div style="position:relative;text-align:center;"><a title="RSS" class="jet-rss-tag-icon" style="position: absolute; bottom: -10px; left: -6px; line-height: 32px;" href="#"></a><p><a href="#">Новини</a>|<a href="#">Галерея</a>|<a href="#">Контакти</a>|<a href="http://www.iconfinder.com/search/?q=iconset:web2badges">Icon set</a> A. <a href="#">IG</a></p><p>Авторське право © 2021. Всі права захищені.</p></div>
        </footer>
